@echo off
rem Uruchomienie GUI klienta JavaFX (clients/desktop-java/) - JDK 21 + Maven 3.9.x.
setlocal
...
call "%MAVEN_HOME9%\bin\mvn.cmd" -B -f "%~dp0..\clients\desktop-java\pom.xml" javafx:run %*
set "RC=%ERRORLEVEL%"
endlocal & exit /b %RC%
